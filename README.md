...
| リスト・プロセスのリマインド作成機能    | 目標日を過ぎたリスト・プロセスを確認しやすくする為。| 目標日・リマインド時刻を基準に、同日時あるいは日時を過ぎたリスト・プロセスのリマインドを作成する。      |
| リマインド一覧表示機能    | 作成されたリマインドを確認できるようにする為。　|作成されたリマインドを一覧表示する。また、未確認のリマインドがある場合は、通知マークを表示する。       |
